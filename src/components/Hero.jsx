    ...
    <section className="max-w-6xl mx-auto px-4 sm:px-6 py-12 md:py-16 lg:py-20 overflow-hidden">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
        ...
        <div className="text-center lg:text-left order-2 lg:order-1">
          <p className="text-gray-700 uppercase tracking-[3px] text-xs sm:text-sm mb-3">
            Find The Best
          </p>

          <h1 className="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-bold leading-tight bg-gradient-to-r from-[#ff7a00] to-[#ffd6bc] bg-clip-text text-transparent pb-2">
            SOFTWARE &
            <br />
            IT COMPANY
          </h1>
